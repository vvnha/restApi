$(document).ready(function() {
    $("#btn-add").click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '/rest/admin/order/vieworder/add',
            data: {
    ...
    $("#btn-edit").click(function() {
        ...
        $.ajax({
            type: 'PUT',
            url: '/rest/admin/order/vieworder/update/' + $("#frmEditTask input[name=task_id]").val(),
            data: {
    ...
    $("#btn-delete").click(function() {
        ...
        $.ajax({
            type: 'DELETE',
            url: '/rest/admin/order/vieworder/delete/' + $("#frmDeleteTask input[name=task_id]").val(),
            dataType: 'json',
            success: function(data) {
...
function editTaskForm(task_id) {
    $.ajax({
        type: 'GET',
        url: '/rest/admin/order/vieworder/detail/' + task_id,
        success: function(data) {
            $("#edit-error-bag").hide();
