                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{url('admin/account/position')}}" method="POST">
                                ...
                                <select name="positionID" class="bg-green" style="width:30%">
                                    ...
                                    <option value="6">5 - Part-time Staff</option>
                                </select>
                        ...
                        <td>
                            ...
                            <form action="{{url('admin/account/changetype')}}" method="POST">
                                {{ csrf_field() }}
                                <input type="" name="id" hidden value="{{$value->id}}">
                                <select name="type" class="bg-green" style="width:30%">
                                    <option value="{{$value->ksalary}}">{{$value->ksalary}}</option>
                                    @foreach($ksalary as $value1)
                                    <option value="{{$value1['id']}}">
                                        {{$value1['id']}}-{{$value1['type']}}-{{$value1['note']}}</option>
                                    @endforeach
                                </select>
                                <button type="submit" class="bg-primary small">CẬP NHẬT</button>
                            </form>
